...
const VectorBackward = new Vector3(0, 0, 1);
...
export class Ray {
    ...
    setParameters(origin: Vector3, direction: Vector3) {
    ...
    intersectBox = function () {
        ...
        const planeIntersectionPointArray: any = [];
        const originArray: any = [];
        const directionArray: any = [];

        return function (this: Ray, box: Box3, outHit: Hit): boolean {
    ...
    intersectSphere = function () {
        ...
        return function (this: Ray, center: Vector3, radius: number, outHit: Hit): boolean {
