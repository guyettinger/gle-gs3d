...
const _changeEvent:EventType = { type: 'change' };
const _startEvent:EventType = { type: 'start' };
const _endEvent:EventType = { type: 'end' };
const _ray = new Ray();
...
class OrbitControls extends EventDispatcher<any> {
    ...
    constructor( object: any, domElement: any ) {
        ...
        this.update = function() {
            ...
            return function update(this: any) {
        ...
        function updateMouseParameters( event: any ) {
        ...
        function clampDistance( dist: any ) {
