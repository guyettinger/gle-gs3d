...
function sortWorker(self: any) {
    ...
    let indexesOffset: number;
    let positionsOffset: number;
    let viewProjOffset: number;
    let indexesOutOffset: number;
    let sortBuffersOffset: number;
...
export function createSortWorker(splatCount: any) {
